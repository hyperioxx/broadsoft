...
class UserPasswordInfoGetRequest(BroadsoftRequest):
    command_name = 'UserPasswordInfoGetRequest'
    ...
    @staticmethod
    def get_password_info(sip_user_id=None, **kwargs):
        u = UserPasswordInfoGetRequest(sip_user_id=sip_user_id, **kwargs)
        xml = u.post()
        return xml
